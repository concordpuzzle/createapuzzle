  ...
  font-style: italic;
    ...
    <div>
        <div style="background-color:#0c2461" class="h-16 w-16 flex items-center justify-center rounded-full">
            <p style="color:#fff;font-size:22px;">⭐</p>
        </div>
...
<a href="https://concordpuzzle.com/shop/500-piece-puzzle-of-a-picture/" class="scale-100 p-6 bg-white rounded-lg shadow-none shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
    <div>
        <div style="background-color:#0c2461" class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
